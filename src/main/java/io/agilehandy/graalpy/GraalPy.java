...
public class GraalPy {
    ...
    public static void main(String[] args) {
        try (Context context = getContext()) {
            Source source;
            try {
                source = Source.newBuilder(PYTHON, "import hello, watsonx", "<internal>").internal(true).build();
            } catch (IOException e) {
            ...
            // watsonx
            Value pyWatsonxClass = context.getPolyglotBindings().getMember("PyWatsonx");
            Value pyWatsonx = pyWatsonxClass.newInstance();
            // cast it to the Watsonx Java interface which matches 
            Watsonx watsonx = pyWatsonx.as(Watsonx.class);

            String WATSONX_PROJECT_ID="d134a61f-4980-4d25-9850-d36e127b7965";
            String IBM_CLOUD_APIKEY="2tbvfA7cWKcEGzcCMyhmziqJ00VEoNN67vjJo1jRI8ye";
            String MODEL_NAME = "meta-llama/llama-3-70b-instruct";

            watsonx.setWatsonxModel(MODEL_NAME, IBM_CLOUD_APIKEY, WATSONX_PROJECT_ID);

            String result = watsonx.invoke("What is the capital of Sudan?"); 
